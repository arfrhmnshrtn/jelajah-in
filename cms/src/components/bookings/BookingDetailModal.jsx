...
const BookingDetailModal = ({ isOpen, onClose, booking, onConfirmPayment }) => {
  ...
  return createPortal(
    <div className="modal-overlay" style={{ position: 'fixed', inset: 0, zIndex: 9999, backgroundColor: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '20px', overflowY: 'auto' }}>
      <div className="modal-content booking-detail-modal" style={{ width: '100%', maxWidth: '500px', margin: 'auto', animation: 'modalScaleUp 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)' }}>
